...
from knowledge_graph.graph.builder import build_graph, update_graph
from knowledge_graph.graph.storage import GraphStore
...
def test_build_and_update_graph(sample_repo_path) -> None:
    ...
    db_path = Path(r"C:\Users\acer\.codex\memories\knowledge-graph-graph-build.sqlite")
