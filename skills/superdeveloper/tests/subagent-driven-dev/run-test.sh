...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superdeveloper
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superdeveloper-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using superdeveloper:subagent-driven-development. The plan is at: $PLAN_PATH"
