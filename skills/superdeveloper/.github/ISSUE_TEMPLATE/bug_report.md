...
| Field | Value |
|-------|-------|
| Superdeveloper version | |
| Harness (Claude Code, Cursor, etc.) | |
| Harness version | |
| Model | |
| OS + shell | |

## Is this a Superdeveloper issue or a platform issue?
<!-- Superdeveloper is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Superdeveloper installed.

     If the problem persists without Superdeveloper, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Superdeveloper installed
