...
> **For agentic workers:** REQUIRED: Use superdeveloper:subagent-driven-development (if subagents available) or superdeveloper:executing-plans to implement this plan.
...
**Spec:** docs/superdeveloper/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/superdeveloper/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use superdeveloper:subagent-driven-development (if subagents available) or superdeveloper:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
